...
namespace edxl_cap_v1_2.Migrations
{
    ...
    [Migration("20180903212403_InfoEdit")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("edxl_cap_v1_2.Models.ContentViewModels.AlertViewModel", b =>
                {
                    b.Property<int>("AlertIndex")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("AlertViewModel");
                });

            modelBuilder.Entity("edxl_cap_v1_2.Models.ContentViewModels.AlertVm", b =>
                {
                    b.Property<int>("AlertIndex")
                        .ValueGeneratedOnAdd();

                    b.Property<int?>("AlertViewModelAlertIndex");
                    ...
                    b.HasIndex("AlertViewModelAlertIndex");

                    b.ToTable("AlertVm");
                });

            modelBuilder.Entity("edxl_cap_v1_2.Models.ContentViewModels.Area", b =>
                {
            ...
            modelBuilder.Entity("edxl_cap_v1_2.Models.ContentViewModels.Resource", b =>
                {
                    b.Property<int>("ResourceIndex")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("edxl_cap_v1_2.Models.EdxlCapMsg", b =>
                {
                    ...
                    b.Property<int?>("SelectedAreaIndex");

                    b.Property<int?>("SelectedInfoIndex");

                    b.Property<int?>("SelectedResourceIndex");
            ...
            modelBuilder.Entity("edxl_cap_v1_2.Models.ContentViewModels.AlertVm", b =>
                {
                    b.HasOne("edxl_cap_v1_2.Models.ContentViewModels.AlertViewModel")
                        .WithMany("Alerts")
                        .HasForeignKey("AlertViewModelAlertIndex");
                });

            modelBuilder.Entity("edxl_cap_v1_2.Models.ContentViewModels.EdxlCapMessageViewModel", b =>
                {
                    b.HasOne("edxl_cap_v1_2.Models.ContentViewModels.Alert", "Alert")
                        .WithMany()
                        .HasForeignKey("AlertIndex1");

                    b.HasOne("edxl_cap_v1_2.Models.ContentViewModels.Area", "Area")
                        .WithMany()
            ...
            modelBuilder.Entity("edxl_cap_v1_2.Models.Element", b =>
                {
                    ...
                    b.HasOne("edxl_cap_v1_2.Models.ContentViewModels.Area")
                        .WithMany("Elements")
                        .HasForeignKey("AreaIndex");
